...
import addToWishlist from '@salesforce/apex/Sandi_WishlistController.addToWishlist';
//import {
...
export default class SearchProductCard extends LightningElement {
    ...
    wiredRecord({error, data}) {
        if(error) {
            ...
            console.log(data);
            this.productDescription = data.fields.Description.value;
        }
    }
    ...
    get addToWishButtonText() {
        return this.configuration?.addToWishButtonText;
    }
        ...
        try {
            await addToWishlist({
                ...
                if(data === null) {
                    ...
                    console.log('i18n.toastTitleSuccess', i18n.toastTitleSuccess);
                    console.log('i18n.toastWishlistSuccess', i18n.toastWishlistSuccess);
                    self.dispatchEvent(
                        new ShowToastEvent({
                            title: i18n.toastTitleSuccess,
                            message: i18n.toastWishlistSuccess,
                            variant: 'success',
                            mode: 'sticky',
                        })
                    );
                    ...
                    self.dispatchEvent(
                        new ShowToastEvent({
                            title: i18n.toastTitleError,
                            message: i18n.toastWishlistError,
                            variant: 'error',
                            mode: 'sticky',
                        })
                    );
